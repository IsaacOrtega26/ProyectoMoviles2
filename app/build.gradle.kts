//con los plugins se activan los modulos que Android necesita para poder entender nuestro proyecto
plugins {
...
android {
    ...
    defaultConfig {
        applicationId = "com.example.arenamovil"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
//Define los tipos de compilación
    buildTypes {
        release {
...
//Aquí se definen las versiones de Java que usara
    compileOptions {
